...
const translations = {
    ...
    es: {
        ...
        aboutRoleDescription: ", con conocimiento en desarrollo y diseño web, ofrezco los mejores proyectos resultando en trabajos de calidad.",
        aboutParagraph: "Aprovecho mi pasión y habilidades para crear productos y experiencias digitales. Con un enfoque en la estética limpia y el diseño intuitivo, trabajo con individuos y empresas para dar vida a sus visiones. Me desarrollo con principios minimalistas y la honestidad brutalista en el diseño.",
